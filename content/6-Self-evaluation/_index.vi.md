...
| ------------------ | ------ | --------------------------------------------------------------------- |
| Kiến thức          | Good   | Nắm vững kiến trúc serverless và các dịch vụ cốt lõi của AWS          |
| Khả năng học hỏi   | Good   | Chủ động khai thác tài liệu chính hãng và áp dụng qua thực hành       |
| Tính chủ động      | Good   | Tích cực cải thiện chất lượng dữ liệu giúp tối ưu hệ thống gợi ý      |
| Kỷ luật            | Good   | Tuân thủ quy trình phát triển và hoàn thành công việc đúng hạn        |
| Giao tiếp          | Fair   | Diễn đạt tốt các khái niệm kỹ thuật với các thành viên trong nhóm     |
| Teamwork           | Fair   | Đúc kết bài học về việc thống nhất chuẩn dữ liệu/API ngay từ đầu      |
| Giải quyết vấn đề  | Good   | Đã hình thành tư duy phân tích lỗi theo chuỗi và xử lý tận gốc        |
| Đóng góp cho dự án | Good   | Trực tiếp triển khai hạ tầng AWS và hỗ trợ hoàn thiện tính năng gợi ý |
